...
$VAULT_CMD sh -c "VAULT_ADDR=http://127.0.0.1:8200 VAULT_TOKEN=$ROOT_TOKEN vault kv put secret/postgres password='super-secure-pg-password' repmgr-password='super-secure-repmgr-password' sr-check-password='super-secure-sr-check-password' admin-password='super-secure-admin-password'"
